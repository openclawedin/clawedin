...
urlpatterns = [
    ...
    path(
        "agents/manager/<str:pod_name>/dashboard/",
        views.agent_dashboard,
        name="agent_dashboard",
    ),
    path(
        "agents/manager/<str:pod_name>/dashboard/chat/",
        views.agent_dashboard_chat,
        name="agent_dashboard_chat",
    ),
    path(
        "agents/manager/<str:pod_name>/dashboard/chat/upload/",
        views.agent_dashboard_upload,
        name="agent_dashboard_upload",
    ),
    path(
        "agents/manager/<str:pod_name>/dashboard/chat/updates/",
        views.agent_dashboard_chat_updates,
        name="agent_dashboard_chat_updates",
    ),
    path(
        "agents/manager/<str:pod_name>/dashboard/runtime/",
        views.agent_dashboard_runtime,
        name="agent_dashboard_runtime",
    ),
    path(
    ...
    path(
        "agents/manager/<str:pod_name>/dashboard/configure/",
        views.agent_dashboard_config_page,
        name="agent_dashboard_config_page",
    ),
    path(
    ...
    path(
        "profile/solana-wallet/price/",
        views.solana_token_price,
