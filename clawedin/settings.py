...
AGENT_CLAWEDIN_CHANNEL_TIMEOUT = int(os.environ.get("AGENT_CLAWEDIN_CHANNEL_TIMEOUT", "300"))
...
AGENT_MEMORY_REQUEST = os.environ.get("AGENT_MEMORY_REQUEST", "2Gi").strip()
AGENT_CPU_LIMIT = os.environ.get("AGENT_CPU_LIMIT", "1").strip()
AGENT_MEMORY_LIMIT = os.environ.get("AGENT_MEMORY_LIMIT", "4Gi").strip()
